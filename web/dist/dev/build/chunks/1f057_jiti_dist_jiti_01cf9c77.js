module.exports = [
"[project]/node_modules/tailwindcss/node_modules/jiti/dist/jiti.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
(()=>{
    var __webpack_modules__ = {
        ...
        module: (module1)=>{
            "use strict";
            module1.exports = __turbopack_context__.r("[externals]/module [external] (module, cjs)");
        },
        path: (module1)=>{
            "use strict";
            module1.exports = __turbopack_context__.r("[externals]/path [external] (path, cjs)");
        }
    ...
    (()=>{
        ...
        const external_perf_hooks_namespaceObject = __turbopack_context__.r("[externals]/perf_hooks [external] (perf_hooks, cjs)"), external_os_namespaceObject = __turbopack_context__.r("[externals]/os [external] (os, cjs)"), external_vm_namespaceObject = __turbopack_context__.r("[externals]/vm [external] (vm, cjs)");
        var external_vm_default = __webpack_require__.n(external_vm_namespaceObject);
        const external_url_namespaceObject = __turbopack_context__.r("[externals]/url [external] (url, cjs)"), _DRIVE_LETTER_START_RE = /^[A-Za-z]:\//;
        ...
        const external_node_module_namespaceObject = __turbopack_context__.r("[externals]/module [external] (module, cjs)"), external_node_fs_namespaceObject = __turbopack_context__.r("[externals]/fs [external] (fs, cjs)");
        ...
        const external_node_url_namespaceObject = __turbopack_context__.r("[externals]/url [external] (url, cjs)"), external_node_assert_namespaceObject = __turbopack_context__.r("[externals]/assert [external] (assert, cjs)"), external_node_process_namespaceObject = __turbopack_context__.r("[externals]/process [external] (process, cjs)"), external_node_path_namespaceObject = __turbopack_context__.r("[externals]/path [external] (path, cjs)"), external_node_v8_namespaceObject = __turbopack_context__.r("[externals]/v8 [external] (v8, cjs)"), external_node_util_namespaceObject = __turbopack_context__.r("[externals]/util [external] (util, cjs)"), BUILTIN_MODULES = new Set(external_node_module_namespaceObject.builtinModules);
        ...
        const _EnvDebug = destr(process.env.JITI_DEBUG), _EnvCache = destr(process.env.JITI_CACHE), _EnvESMResolve = destr(process.env.JITI_ESM_RESOLVE), _EnvRequireCache = destr(process.env.JITI_REQUIRE_CACHE), _EnvSourceMaps = destr(process.env.JITI_SOURCE_MAPS), _EnvAlias = destr(process.env.JITI_ALIAS), _EnvTransform = destr(process.env.JITI_TRANSFORM_MODULES), _EnvNative = destr(process.env.JITI_NATIVE_MODULES), _ExpBun = destr(process.env.JITI_EXPERIMENTAL_BUN), isWindows = "win32" === (0, external_os_namespaceObject.platform)(), defaults = {
            debug: _EnvDebug,
        ...
        function createJITI(_filename, opts = {}, parentModule, parentCache) {
            ...
            const nativeRequire = create_require_default()(("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : _filename), tryResolve = (id, options)=>{
                try {
...
//# sourceMappingURL=1f057_jiti_dist_jiti_01cf9c77.js.map